...
<div id="wrap">
	<div id="header">
		<div class="logo">
			<a href="<?php bloginfo('home'); echo "/"; ?>"><img src="<?php echo ide_option('logo_url') ? ide_option('logo_url') : get_bloginfo('template_url').'/images/logo.png';  ?>" alt="<?php bloginfo('name'); ?>" title="<?php bloginfo('name'); ?>" /></a>
